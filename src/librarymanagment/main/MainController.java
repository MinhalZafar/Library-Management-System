...
public class MainController implements Initializable {
    ...
    private void LoadAddMember(ActionEvent event) {
        loadwindow("/librarymanagment/addmember/member_add.fxml", "Add New Member");
    }

    @FXML
    private void LoadBookTable(ActionEvent event) {
        loadwindow("/librarymanagment/booklist/Book_List.fxml", "View Book List");
    }

    @FXML
    private void LoadMemberTable(ActionEvent event) {
        loadwindow("/librarymanagment/memberlist/ListMember.fxml", "View Member List");
    }

    @FXML
    private void loadSettings(ActionEvent event) {
        loadwindow("/librarymanagment/setting/Setting.fxml", "Settings");
    ...
    private void LoadAddBook(ActionEvent event) {
        loadwindow("/librarymanagment/FXMLDocument.fxml", "Add New Book");
    }
...
if (checkForIssueValidity()) {
   ...
   private void enableDisableGraph(Boolean status) {
    ...
    @FXML
    private void loadrefreshOperation(ActionEvent event) {
